...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.btnSignUpMain).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    EditText txtFirstName = (EditText) getActivity().findViewById(R.id.txtFirstName);
                    EditText txtLastName = (EditText) getActivity().findViewById(R.id.txtLastName);

                            mListener.SignUP(txtEmail.getText().toString(), txtPwd.getText().toString(), txtFirstName.getText().toString() + " " + txtLastName.getText().toString());
                }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void SignUP(String EmailID, String Password, String Name);
    }
}
